...
// this also pins body to the current scroll position while locked (scrollY is
// captured before the lock and applied via `top`, so there's no visual jump
// when position: fixed takes effect).
//
