      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="glass-panel rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden h-full w-full bg-black/40 backdrop-blur-3xl flex flex-col items-center text-center">
            ...
            <div className="w-20 h-20 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center mb-8 relative z-10">
            ...
            <p className="text-muted leading-relaxed mb-10 max-w-xs mx-auto relative z-10">
              We use your X account to verify your identity and follower count.
            </p>

            <button 
              onClick={handleTwitterLogin}
              disabled={isLoggingIn}
              className="w-full py-4 rounded-full bg-white text-black font-semibold flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] relative z-10 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <XLogo className="w-5 h-5 text-black" />
              {isLoggingIn ? 'Connecting...' : 'Connect with X'}
            </button>
            
            <p className="mt-8 text-xs text-muted max-w-[250px] mx-auto relative z-10">
              By connecting, you agree to SorsaMarket's Terms of Service and Privacy Policy.
            </p>
          </div>
        </motion.div>
      </div>
