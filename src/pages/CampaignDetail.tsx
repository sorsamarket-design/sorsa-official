...
export default function CampaignDetail() {
  ...
  return <div className="min-h-screen bg-[#0A0A1E] text-[#F5F5F7] font-sans selection:bg-cyan/30 flex"><BrandSidebar /><TopBar /><main className="flex-1 md:ml-64 mt-[5.625rem] p-4 md:p-8"><div className="max-w-6xl mx-auto">{loading ? <div className="glass-panel rounded-[2rem] p-10 flex items-center justify-center"><Loader2 className="w-8 h-8 text-cyan animate-spin" /></div> : !campaign ? <div className="glass-panel rounded-[2rem] p-10 text-center text-muted">Campaign not found.</div> : <>
