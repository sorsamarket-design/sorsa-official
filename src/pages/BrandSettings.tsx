...
import { Settings as SettingsIcon, Building2, Bell, Shield, Users, Save } from 'lucide-react';
                    ...
                    >
                      ...
                      <div className="flex items-center gap-6">
                        <div className="w-20 h-20 rounded-2xl bg-white/5 border border-white/20 flex items-center justify-center overflow-hidden">
                          <img 
                            src="https://picsum.photos/seed/brand/150/150" 
                            alt="Logo" 
                            className="w-full h-full object-cover"
                            referrerPolicy="no-referrer"
                          />
                        </div>
                        <button type="button" className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white text-sm font-medium hover:bg-white/10 transition-colors">
                          Upload Logo
                        </button>
                      </div>
                      ...
                      <div>
                        ...
                        <textarea 
                          defaultValue="Leading provider of innovative tech solutions."
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                          ...
                          <p className="text-sm text-muted mb-4">Update your account password.</p>
                          <button type="button" className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white text-sm font-medium hover:bg-white/10 transition-colors">
                            Update Password
                          </button>
                        </div>
                        ...
                        <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                          <h3 className="font-medium text-white mb-1">Two-Factor Authentication (2FA)</h3>
                          <p className="text-sm text-muted mb-4">Add an extra layer of security to your account.</p>
                          <button type="button" className="px-4 py-2 rounded-xl bg-cyan/10 text-cyan border border-cyan/20 text-sm font-medium hover:bg-cyan/20 transition-colors">
                            Enable 2FA
                          </button>
                        </div>
                      </div>
